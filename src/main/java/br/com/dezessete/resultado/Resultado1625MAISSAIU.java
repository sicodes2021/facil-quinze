package br.com.dezessete.resultado;
...
public class Resultado1625MAISSAIU {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {
		...
		int cont = 0;
		URL combinacao1625 = Resultado1625MAISSAIU.class.getClassLoader().getResource("combinacoes\\16_25-2042975\\16_25.csv");
		if (Objects.nonNull(combinacao1625)) {
			...
			while (Objects.nonNull((linhaCombinacao = csvReader.readNext()))) {
				...
				String lista = null;
				int retornoQuatorze = resultado1625SAIUQUATORZE(linhaCombinacao1625);
				int retornoQuinze = resultado1625SAIUQUINZE(linhaCombinacao1625);
				int frequencia = frequenciaResultado1625SAIU(linhaCombinacao1625);
//				if (retorno > NumeroEnum.ZERO.getValor()) {
					lista = linhaCombinacao1625[0] + "," + linhaCombinacao1625[1] + "," + linhaCombinacao1625[2] + "," + linhaCombinacao1625[3] + "," 
							+ linhaCombinacao1625[4] + "," + linhaCombinacao1625[5] + "," + linhaCombinacao1625[6] + "," + linhaCombinacao1625[7] + "," 
							+ linhaCombinacao1625[8] + "," + linhaCombinacao1625[9] + "," + linhaCombinacao1625[10] + "," + linhaCombinacao1625[11] + "," 
							+ linhaCombinacao1625[12] + "," + linhaCombinacao1625[13] + "," + linhaCombinacao1625[14] + "," + linhaCombinacao1625[15] + "," 
							+ retornoQuatorze + "," + retornoQuinze + "," + frequencia;
...
//				}
	...
	@SuppressWarnings({ "deprecation" })
	public static int resultado1625SAIUQUATORZE(int[] linhaCombinacao1625)
	...
	@SuppressWarnings({ "deprecation" })
	public static int resultado1625SAIUQUINZE(int[] linhaCombinacao1625)
			throws URISyntaxException, NumberFormatException, IOException {
