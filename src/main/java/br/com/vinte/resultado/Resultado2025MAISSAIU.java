...
public class Resultado2025MAISSAIU {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {
		...
		FileWriter arqSaiu = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\vinte\\Resultado2025MAISSAIU_conc3045.csv");
		PrintWriter gravarArqSaiu = new PrintWriter(arqSaiu);

		int cont = 0;
		URL combinacao1825 = Resultado2025MAISSAIU.class.getClassLoader().getResource("vinte\\2025RNP05_09.csv");
