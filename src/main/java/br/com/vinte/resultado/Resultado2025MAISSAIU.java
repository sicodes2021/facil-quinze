...
public class Resultado2025MAISSAIU {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {
		...
		FileWriter arqSaiu = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\vinte\\Resultado2025SEMRNS_CONC_3104.csv");
		PrintWriter gravarArqSaiu = new PrintWriter(arqSaiu);

		int cont = 0;
		URL combinacao1825 = Resultado2025MAISSAIU.class.getClassLoader().getResource("combinacoes\\20_25-53130\\20_25-RNP07_SEMRNS.csv");
	...
	public static int resultado1825SAIU(int[] linhaCombinacao1825) throws URISyntaxException, NumberFormatException, IOException {
		...
		int contJogo = 0;
		int qtdJogoSaiu = 0;
		URL resultado1825SAIU = Resultado2025MAISSAIU.class.getClassLoader().getResource("resultado.csv");
