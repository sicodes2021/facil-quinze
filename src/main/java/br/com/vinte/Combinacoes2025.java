...
public class Combinacoes2025 {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {
		...
		combinacoes1525.gerar2025(str);
		combinacoes1525.gerar2025SEMRNS(str);
//		List<String> listaCombinacoes2025RNP05_09 = combinacoes1525.gerar2025RNP05_09();
//		combinacoes1525.gravar(combinacoes1525.gerar2025SEMRNS(), "2025SEMRNS_CONC_3052");
...
//		combinacoes1525.juntar89_1416();
	 ...
	 * @return List<String>
	 */
	public List<String> gerar2025(int[] str) throws URISyntaxException, IOException, LotoException {
...
//		gravarArquivo1525.close();
	...
	/**
	 * Metodo responsavel por gerar as combinacoes 2025 = 3125
	 * 
	 * @return List<String>
	 */
	public List<String> gerar2025SEMRNS(int[] str) throws URISyntaxException, IOException, LotoException {
		FileWriter arquivo1525 = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\vinte\\20_25_SEMRNS.csv");
		PrintWriter gravarArquivo1525 = new PrintWriter(arquivo1525);
		...
		arquivo1525.close();
		gravarArquivo1525.close();
		System.out.println("TOTAL DE LINHAS NO ARQUIVO 20_25_SEMRNS: " + cont);
		return lista1525;
	}
...
//		gravarArquivo1525.close();
	 ...
	 */
	public List<String> gerar2025RNP07() throws URISyntaxException, IOException, LotoException {
		FileWriter arquivoRNP07 = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\combinacoes\\20_25-53130\\20_25-RNP07.csv");
		...
		System.out.println("TOTAL DE LINHAS NO ARQUIVO 20_25-RNP07: " + cont);
		return lista1525;
	}
	 ...
	 * @throws LotoException
	 */
	public List<String> gerar2025RNP07SEMRNS() throws URISyntaxException, IOException, LotoException {
		FileWriter arquivoRNP07 = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\combinacoes\\20_25-53130\\20_25-RNP07_SEMRNS.csv");
		PrintWriter gravarArquivoRNP07 = new PrintWriter(arquivoRNP07);
		...
		arquivoRNP07.close();
		gravarArquivoRNP07.close();
		System.out.println("TOTAL DE LINHAS NO ARQUIVO 20_25-RNP07_SEMRNS: " + cont);
		return lista1525;
	}
...
//		System.out.println("TOTAL DE LINHAS NO ARQUIVO 15_25-RNP07: " + cont);
	...
	public void resultadoNumerosMenorQueDezRNP07() throws URISyntaxException, IOException, LotoException {
		...
		int oito = 0;
		int nove = 0;
		URL resultado1525 = Combinacoes2025.class.getClassLoader().getResource("combinacoes\\15_25-3268760\\RNP07\\15_25-RNP07.csv");
	 ...
	 * @throws LotoException
	 */
	public List<String> gerar2025RNP08() throws URISyntaxException, IOException, LotoException {
		FileWriter arquivoRNP08 = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\combinacoes\\20_25-53130\\20_25-RNP08.csv");
		...
		System.out.println("TOTAL DE LINHAS NO ARQUIVO 20_25-RNP08: " + cont);
		return lista1525;
	}
	...
	public void resultadoNumerosMenorQueDezRNP08() throws URISyntaxException, IOException, LotoException {
		...
		int oito = 0;
		int nove = 0;
		URL resultado1525 = Combinacoes2025.class.getClassLoader().getResource("combinacoes\\15_25-3268760\\RNP08\\15_25-RNP08.csv");
		if (Objects.nonNull(resultado1525)) {
			Path caminho = Paths.get(resultado1525.toURI());
			CSVReader csvReader = new CSVReader(new FileReader(caminho.toFile()), ',');
	 ...
	 * @throws LotoException
	 */
	public List<String> gerar2025RNP09() throws URISyntaxException, IOException, LotoException {
		FileWriter arquivoRNP09 = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\combinacoes\\20_25-53130\\20_25-RNP09.csv");
		...
		System.out.println("TOTAL DE LINHAS NO ARQUIVO 20_25-RNP09: " + cont);
		return lista1525;
	}
...
//		PrintWriter gravarArquivoZERO = new PrintWriter(arquivoZERO);
		...
		int oito = 0;
		int nove = 0;
		URL resultado1525 = Combinacoes2025.class.getClassLoader().getResource("combinacoes\\15_25-3268760\\RNP09\\15_25-RNP09.csv");
		if (Objects.nonNull(resultado1525)) {
			Path caminho = Paths.get(resultado1525.toURI());
			CSVReader csvReader = new CSVReader(new FileReader(caminho.toFile()), ',');
...
//			gravarArquivoZERO.close();
	 ...
	 * @throws LotoException
	 */
	public List<String> gerar2025RNP10() throws URISyntaxException, IOException, LotoException {
		FileWriter arquivoRNP10 = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\combinacoes\\20_25-53130\\20_25-RNP10.csv");
		...
		System.out.println("TOTAL DE LINHAS NO ARQUIVO 20_25-RNP10: " + cont);
		return lista1525;
	}
...
//		PrintWriter gravarArquivoUM = new PrintWriter(arquivoUM);
		...
		int oito = 0;
		int nove = 0;
		URL resultado1525 = Combinacoes2025.class.getClassLoader().getResource("combinacoes\\15_25-3268760\\RNP10\\15_25-RNP10.csv");
		if (Objects.nonNull(resultado1525)) {
			Path caminho = Paths.get(resultado1525.toURI());
			CSVReader csvReader = new CSVReader(new FileReader(caminho.toFile()), ',');
...
//		PrintWriter gravarArquivoNOVE = new PrintWriter(arquivoNOVE);
		...
		int oito = 0;
		int nove = 0;
		URL resultado1525 = Combinacoes2025.class.getClassLoader().getResource("combinacoes\\15_25-3268760\\RNP11\\15_25-RNP11.csv");
		if (Objects.nonNull(resultado1525)) {
			Path caminho = Paths.get(resultado1525.toURI());
			CSVReader csvReader = new CSVReader(new FileReader(caminho.toFile()), ',');
...
//		PrintWriter gravarArquivoNOVE = new PrintWriter(arquivoNOVE);
		...
		int oito = 0;
		int nove = 0;
		URL resultado1525 = Combinacoes2025.class.getClassLoader().getResource("combinacoes\\15_25-3268760\\RNP12\\15_25-RNP12.csv");
		if (Objects.nonNull(resultado1525)) {
			Path caminho = Paths.get(resultado1525.toURI());
			CSVReader csvReader = new CSVReader(new FileReader(caminho.toFile()), ',');
