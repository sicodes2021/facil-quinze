...
public class Resultado1625MAISSAIU {
	...
	public static void main(String[] args) throws URISyntaxException, IOException, LotoException {
		...
		FileWriter arqSaiu = new FileWriter("C:\\sicodes\\facil-quinze\\src\\main\\resources\\resultado\\16_25\\Resultado1825MAISSAIU_conc3021.csv");
		PrintWriter gravarArqSaiu = new PrintWriter(arqSaiu);

		int cont = 0;
		URL combinacao1825 = Resultado1625MAISSAIU.class.getClassLoader().getResource("combinacoes\\16_25-2042975\\16_25.csv");
