	...
	public void Combinacoes1525() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\15_25.csv");
	...
	public void RNP03() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP03\\15_25-RNP03.csv");
	...
	public void RNP04() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP04\\15_25-RNP04.csv");
	...
	public void RNP05() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP05\\15_25-RNP05.csv");
	...
	public void RNP06() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP06\\15_25-RNP06.csv");
	...
	public void RNP07() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP07\\15_25-RNP07.csv");
	...
	public void RNP08() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP08\\15_25-RNP08.csv");
	...
	public void RNP09() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP09\\15_25-RNP09.csv");
	...
	public void RNP10() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP10\\15_25-RNP10.csv");
	...
	public void RNP11() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP11\\15_25-RNP11.csv");
	...
	public void RNP12() throws URISyntaxException, IOException, LotoException {
		...
		if (Objects.nonNull(resultado1525)) {
			...
			while (Objects.nonNull((linhaResultado1525 = csvReader.readNext()))) {	
				...
				URL combinacoes = IAcertei.class.getClassLoader().getResource("\\combinacoes\\15_25-3268760\\RNP12\\15_25-RNP12.csv");
